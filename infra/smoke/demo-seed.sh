...
summary() {
  ...
  웹  http://localhost:3100   로그인하면 역할이 목적지를 정합니다
  앱  http://localhost:3300   로그인하면 역할이 셸을 정합니다

  운영자         01011110001   웹 → /admin
  기관 (검증완료) 01022220001   웹 → /org
  기관 (검증대기) 01022220002   웹 → /org   ← 개인정보 게이트 비교용
  후보자         01033330001   앱          ← 배치 준비 · 서류 2건 (1건 D-20)
