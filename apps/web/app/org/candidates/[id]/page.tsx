...
import { errorLabel, label } from '@/lib/labels-org';
      ...
      return (
        <OrgShell orgName={org.name} verificationStatus={org.verificationStatus}>
          ...
          <div className="cl-body" style={{ marginTop: 'var(--cl-s6)' }}>
            <ErrorNotice code={e.body.code} details={e.body.details} labeler={errorLabel} />
          </div>
        </OrgShell>
      );
    }
  ...
  return (
    <OrgShell orgName={org.name} verificationStatus={org.verificationStatus}>
      <PageHeader
        ...
        actions={<Link href="/org/candidates" style={{ fontSize: 'var(--cl-caption)' }}>← 검색으로</Link>}
      />
