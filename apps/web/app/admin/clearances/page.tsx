        ...
        <Section
          ...
          aside={
            <div style={{ display: 'flex', gap: 'var(--cl-s2)', fontSize: 'var(--cl-caption)' }}>
              <a href="/admin/clearances" style={{ color: !searchParams.result && !searchParams.expiring ? 'var(--cl-action-text)' : 'var(--cl-text-sub)' }}>전체</a>
              <span style={{ color: 'var(--cl-line-strong)' }}>·</span>
              <a href="/admin/clearances?expiring=30" style={{ color: searchParams.expiring ? 'var(--cl-action-text)' : 'var(--cl-text-sub)' }}>만료 30일 이내</a>
              <span style={{ color: 'var(--cl-line-strong)' }}>·</span>
              <a href="/admin/clearances?result=PENDING" style={{ color: searchParams.result === 'PENDING' ? 'var(--cl-action-text)' : 'var(--cl-text-sub)' }}>검사 대기</a>
              <span style={{ color: 'var(--cl-line-strong)' }}>·</span>
              <a href="/admin/clearances?result=FAIL" style={{ color: searchParams.result === 'FAIL' ? 'var(--cl-action-text)' : 'var(--cl-text-sub)' }}>불합격</a>
            </div>
          }
        >
          <DataTable
