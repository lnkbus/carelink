 ...
 * 퇴근~출근 최소 간격 (시간).
 *
 * 24시간 상주를 막아도 8시간 교대를 연달아 받으면 실제로는 24시간입니다.
 * 이 상수가 그 우회를 막습니다. EU 근로시간지침의 일일 연속휴식(11시간)을
 * 기준으로 잡았습니다 — 국내법이 명시적으로 요구하는 값은 아니지만,
 * 우회를 막는 실효적 기준이 이것뿐입니다.
 *
 * **테이블이 아니라 상수인 이유**: 값을 낮출 수 있게 만들면 인력이 부족한
 * 날 낮추게 되고, 그 날이 사고가 나는 날입니다.
 */
