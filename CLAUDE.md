...
| 8 | `DirectEmploymentStrategy`의 급여 계산 로직 구현 | **U1·U2는 2026-08-21 해소**(파견 확정)됐으나 **U5**(24시간 간병의 휴게·대기 시간 판정)가 남아 있습니다. 이 판정이 연장·야간 수당을 통째로 바꿉니다. 인터페이스와 스키마까지만 두고 대기 |
